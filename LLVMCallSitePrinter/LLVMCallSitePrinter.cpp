//===- LLVMCallSitePrinter.cpp - Example code from "Writing an LLVM Pass" ---------------===//
//
...
namespace {
  ...
  struct LLVMCallSitePrinter: public ModulePass{
    static char ID; // Pass identification, replacement for typeid
    LLVMCallSitePrinter() : ModulePass(ID) {}
...
char LLVMCallSitePrinter::ID = 0;
static RegisterPass<LLVMCallSitePrinter>
Y("LLVMCallSitePrinter", "print callsites");
